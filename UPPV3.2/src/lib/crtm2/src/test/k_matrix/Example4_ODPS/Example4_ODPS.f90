...
! Example4_ODPS
!
! Example4: Program to provide a (relatively) simple example of how
!           to call the CRTM K-Matrix function.
!           The input gases variables include H2O, O3, and CO2 
!           (CO2 is not a variable gas for the ODAS (also known as OPTRAN) algorithm,  
!           but is a variable gas for the ODPS algorithm).
!           To run CRTM for the ODPS transmittance algorithm, the TauCoeff file generated
!           from the ODPS algorithm must be provided.  
!
!
! CREATION HISTORY:
!       Written by:     Paul van Delst, 01-Feb-2008
!                       paul.vandelst@noaa.gov
!       Modified by:    Yong Chen, 27-Jan-2010
!                       yong.chen@noaa.gov
!

PROGRAM Example4_ODPS
  ...
  ! Parameters
  ! ----------
  CHARACTER(*), PARAMETER :: PROGRAM_NAME   = 'Example4_ODPS'
  CHARACTER(*), PARAMETER :: PROGRAM_RCS_ID = &
    '$Id: Example4_ODPS.f90 22707 2012-11-21 21:09:10Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Load_AtmSfc_Data()
    ...
    Atmosphere(1)%Absorber_Id    = (/ H2O_ID                 , O3_ID                    , CO2_ID /)
    Atmosphere(1)%Absorber_Units = (/ MASS_MIXING_RATIO_UNITS, VOLUME_MIXING_RATIO_UNITS, VOLUME_MIXING_RATIO_UNITS /)
    ...
    Atmosphere(1)%Absorber(:,3) = 380.0_fp  
    ...
    Atmosphere(2)%Absorber_Id    = (/ H2O_ID                 , O3_ID                    , CO2_ID /)
    Atmosphere(2)%Absorber_Units = (/ MASS_MIXING_RATIO_UNITS, VOLUME_MIXING_RATIO_UNITS, VOLUME_MIXING_RATIO_UNITS /)
