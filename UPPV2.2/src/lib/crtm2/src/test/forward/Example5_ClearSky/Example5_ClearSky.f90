...
!           to call the CRTM Forward function for clear sky conditions.
!
!
! CREATION HISTORY:
!       Written by:     Paul van Delst, 26-May-2010
!                       paul.vandelst@noaa.gov
!

PROGRAM Example5_ClearSky
  ...
  ! Parameters
  ! ----------
  CHARACTER(*), PARAMETER :: PROGRAM_NAME   = 'Example5_ClearSky'
  CHARACTER(*), PARAMETER :: PROGRAM_VERSION_ID = &
    '$Id: Example5_ClearSky.f90 22707 2012-11-21 21:09:10Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Load_AtmSfc_Data()
    ...
    Sfc(1)%Land_Temperature  = 275.0_fp
  
    Sfc(1)%Water_Coverage    = 0.9_fp
    Sfc(1)%Water_Type        = SEA_WATER
    Sfc(1)%Water_Temperature = 272.0_fp
